...
<head>
    ...
    <title>Detail Laporan #{{ $pengaduan->id }} — Admin</title>
                    ...
                    <div style="display: grid; gap: 3rem;">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 2rem; padding: 2rem; border: 1px solid var(--color-gray-200);">
                            ...
                            <div>
                                ...
                                <div style="font-size: 1.125rem; font-weight: 600;">
                                    {{ $pengaduan->petugas ? $pengaduan->petugas->nama_pengguna : '-' }}
                                </div>
                                <div style="font-size: 0.875rem; color: var(--color-gray-600); margin-top: 0.25rem;">
                                    {{ $pengaduan->petugas ? 'Petugas' : 'Belum ditangani' }}
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <h3 style="margin-bottom: 1.5rem;">CATATAN PETUGAS</h3>
                            <div style="border-left: 4px solid var(--color-gray-300); padding-left: 1.5rem; font-size: 1rem; line-height: 1.8; color: var(--color-gray-700); background: var(--color-gray-50); padding: 1.5rem;">
                    ...
                    <div>
                        <div style="position: sticky; top: 100px;">
                            <div style="border: 2px solid var(--color-black); padding: 2rem; background: var(--color-white);">
                                <h3 style="margin-bottom: 2rem;">UPDATE STATUS (ADMIN)</h3>
                                ...
                                <form action="{{ route('admin.pengaduan.update-status', $pengaduan->id) }}" method="POST">
                                    ...
                                    <div class="mono-form-group">
                                        <label class="mono-label" for="catatan_admin">Catatan Admin</label>
                                        <textarea 
                                            id="catatan_admin" 
                                            name="catatan_admin" 
                                            class="mono-textarea"
                                            placeholder="Berikan catatan atau update progress dari admin..."
                                            style="min-height: 150px;">{{ old('catatan_admin', $pengaduan->catatan_admin) }}</textarea>
                                ...
                                <div>
                                    <h6 style="margin-bottom: 1rem; color: var(--color-gray-600);">CATATAN ADMIN SAAT INI</h6>
                            ...
                            <a href="{{ route('admin.laporan') }}" class="mono-btn mono-btn-ghost" style="width: 100%; text-align: center;">
                                ← Kembali ke Laporan
                            </a>
                        </div>
                    </div>
