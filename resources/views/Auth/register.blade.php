...
<head>
    ...
    <title>Create Account — Facility Management System</title>
    ...
    <div class="container">
        ...
        <div class="hero-panel">
            <div class="hero-content">
                ...
                <h1 class="hero-title">
                    Join Our<br>Excellence Network
                </h1>
                <p class="hero-subtitle">
                    Create your account to access our comprehensive facility management platform. Experience seamless reporting and efficient coordination.
                </p>
            </div>
        ...
        <div class="form-panel">
            ...
            @if ($errors->any())
                <div style="padding: 1rem; background: #ffebee; border-left: 3px solid #d32f2f; border-radius: 6px; margin-bottom: 1.5rem;">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <select id="role" name="role" class="form-control" required>
                            ...
                            <option value="guru" {{ old('role') == 'guru' ? 'selected' : '' }}>Faculty Member</option>
